...
const List<Doctor> kDoctors = [
  Doctor(
    ...
    imageUrl: "https://images.unsplash.com/photo-1559839734-2b71f153678e?w=400",
    fee: "TZS 35,000",
    experience: "12 years",
  ...
  Doctor(
    ...
    imageUrl: "https://images.unsplash.com/photo-1614644147798-f8c0fc9da7f6?w=400",
    fee: "TZS 50,000",
    experience: "14 years",
    languages: "Swahili, English",
  ...
  Doctor(
    ...
    imageUrl: "https://images.unsplash.com/photo-1519824145371-296894a0daa9?w=400",
    fee: "TZS 30,000",
    experience: "10 years",
    languages: "Swahili",
          ...
          Row(
            ...
            children: [
              const Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Habari, Baraka 👋", style: TextStyle(color: Colors.white70, fontSize: 14)),
                  SizedBox(height: 2),
                  ...
                  Row(
                    children: [
                      ...
                      const Expanded(child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("Baraka Mwangi", style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
          ...
          children: [
            ...
            Container(
              ...
              child: Column(children: [
                ...
                const SizedBox(height: 12),
                const Text("Baraka Mwangi", style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
            ...
            _profileSection("Personal Information", [
              _infoRow(Icons.person_outline, "Full Name", "Baraka Mwangi"),
              ...
              _infoRow(Icons.email_outlined, "Email", "baraka@email.com"),
